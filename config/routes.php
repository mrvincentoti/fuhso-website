...
$routes->connect('/about-fuhso', ['controller' => 'Pages', 'action' => 'about']);
    $routes->connect('/principal-officers', ['controller' => 'Pages', 'action' => 'principal']);
    $routes->connect('/council-members', ['controller' => 'Pages', 'action' => 'members']);
    $routes->connect('/vice-chancellor', ['controller' => 'Pages', 'action' => 'vc']);
    $routes->connect('/faculties-and-departments', ['controller' => 'Pages', 'action' => 'faculty']);
    $routes->connect('/news-and-events', ['controller' => 'Pages', 'action' => 'news']);
    $routes->connect('/asked-questions', ['controller' => 'Faqs', 'action' => 'faq']);
    $routes->connect('/list-questions', ['controller' => 'Faqs', 'action' => 'index']);
