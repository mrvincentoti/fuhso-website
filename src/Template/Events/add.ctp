                    ...
                    <div class="col-md-12">
                        <?= $this->Form->create($event,['type'=>'file']) ?>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <!--?php
                                echo $this->Form->control('description', ['class'=>'form-control','id'=>'editor','label'=>false]);
                                ?-->
                                 <?= $this->Form->control('description',['label'=>false,'placeholder'=>'Criteria'
                                            ,'class'=>'form-control ckeditor','type'=>'textarea']) ?>
                            </div>
                            <div class="form-group mb-3">
                            ...
                            <div class="form-group mb-3">
                                <label for="example-select">Type (News or Event?)</label>
                            ...
                            <div class="form-group mb-3">
                                <label for="example-select">Featured</label>
