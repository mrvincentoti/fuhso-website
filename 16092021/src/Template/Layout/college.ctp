...
<head>
  ...
  <?=
    $this->Html->css([
      'edun/slick','edun/animate','edun/nice-select','edun/jquery.nice-number.min','edun/magnific-popup',
      'bootstrap.min','edun/font-awesome.min','edun/default',
      'edun/style','responsive'
    ])
...
<body>
    ...
    <?=
      $this->Html->script([
          'edun/vendor/modernizr-3.6.0.min','edun/vendor/jquery-1.12.4.min','edun/bootstrap.min',
          'edun/slick.min','edun/jquery.magnific-popup.min','edun/waypoints.min','edun/jquery.counterup.min',
          'edun/jquery.nice-select.min','edun/jquery.nice-number.min','edun/jquery.countdown.min','edun/validator.min',
          'edun/ajax-contact','edun/main'
      ])
    ?>
    <?= $this->fetch('script') ?>
